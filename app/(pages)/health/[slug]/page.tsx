// app/(pages)/health/[slug]/page.tsx
import { getPostBySlug, getHealth } from "@/lib/api";
...
export default async function Page({
  ...
  // Fetch other health news articles (excluding current one)
  const otherNewsData = await getHealth();
