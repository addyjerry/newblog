// app/(pages)/culture/[slug]/page.tsx
import { getPostBySlug, getCulture } from "@/lib/api";
...
export default async function Page({
  ...
  // Fetch other culture articles (excluding current one)
  const otherNewsData = await getCulture();
