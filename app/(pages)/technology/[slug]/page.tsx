// app/(pages)/technology/[slug]/page.tsx
import { getPostBySlug, getTechnology } from "@/lib/api";
...
export default async function Page({
  ...
  // Fetch other technology news articles (excluding current one)
  const otherNewsData = await getTechnology();
